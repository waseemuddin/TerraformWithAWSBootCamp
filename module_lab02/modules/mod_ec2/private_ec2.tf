...
resource "aws_instance" "private-machine" {
    ...
    tags = {
        Name: "${var.vpc_name}-Private-Machine"
    ...
    #!/bin/bash
        ...
        sudo cp SecOps-game/index.html /var/www/html/index.html
   	    echo "<div><h1>${var.vpc_name}-Private-Machine</h1></div>" >> /var/www/html/index.html
...
###echo "<div><h1>${var.vpc_name}-Private-Machine-${count.index + 1}</h1></div>" >> /var/www/html/index.html
